...
<div id="login-container">
    ...
    <div id="login">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="login-form">
            ...
            <input type="text" name="log-emailorusername" id="email-or-phone" class="styled-form-input" value="<?php echo $submitted_usernameoremail; ?>">
            ...
            <input type="password" name="log-password" id="user-password" class="styled-form-input" value="<?php echo $submitted_password; ?>">
