<div class="left-side-pannel-options-container">
    ...
    <div class="pannel-option">
        ...
        <nav class="panel-button-related-items-container" id="product-related-items">
            ...
            <a href="https://localhost/E-COMMERCE/Admin/entities/product-management/manage-products.php" class="admin-panel-button manage" id="manage-product">Manage product</a>
