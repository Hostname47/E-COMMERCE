...
<div id="login-container">
    ...
    <div id="login">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="login-form">
            ...
            <input type="password" name="log-password" id="user-password" class="styled-form-input" value="<?php if(isset($_COOKIE["username_password"])) { echo $_COOKIE["username_password"];} ?>">
